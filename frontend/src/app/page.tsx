      ...
      <main className="flex-1">
        <div className="container mx-auto px-4 py-12">
          <div className="flex gap-4 mb-8 animate-fade-in">
            <Badge variant="secondary" className="animate-pulse bg-red-500 text-white hover:bg-red-600 transition-colors">
              BREAKING NEWS
            </Badge>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {stories.map((story) => (
              <div key={story.id} className="transform hover:scale-[1.02] transition-all duration-200 hover:shadow-lg">
                <StoryCard
                  id={story.id}
